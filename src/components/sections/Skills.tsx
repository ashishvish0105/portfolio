...
export function Skills() {
  return (
    <section id="skills" className="relative py-32 px-6 lg:px-8 bg-surface/20">
        ...
        <div className="mt-16 grid grid-cols-1 md:grid-cols-3 gap-px bg-border border border-border">
          {groups.map((g, gi) => (
            <motion.div
              ...
              className="bg-background p-8 hover:bg-surface/40 transition-colors"
            >
              <div className="flex items-center gap-3 mb-8">
                <span className="font-mono text-[10px] text-glow tracking-widest">
                  0{gi + 1}
                </span>

        ...
        <div className="mt-16 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-px bg-border border border-border">
          {services.map((s, i) => (
            <motion.div
              ...
              className="group relative bg-background p-8 hover:bg-surface/40 transition-all duration-300 min-h-[260px] flex flex-col"
            >
              <div className="flex items-start justify-between">
                <div className="size-12 flex items-center justify-center bg-surface-elevated border border-border text-glow group-hover:border-glow/40 group-hover:bg-glow/10 transition-all">
              ...
              <div className="mt-auto pt-6 h-px w-0 bg-glow group-hover:w-full transition-all duration-500" />
            </motion.div>
          ))}
        </div>
      </div>

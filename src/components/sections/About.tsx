  ...
  return (
    <section id="about" className="relative py-32 px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mt-16 grid grid-cols-12 gap-10 lg:gap-16 items-start">
          <motion.div
          ...
          >
            <p className="text-2xl md:text-3xl text-foreground font-light leading-snug tracking-tight">
              I architect{" "}
          ...
          <div className="col-span-12 lg:col-span-5 grid gap-4">
            {cards.map((c, i) => (
              <motion.div
                ...
                className="glass p-6 group hover:border-glow/40 transition-all duration-300"
              >
                <div className="flex items-start gap-4">
                  <div className="size-10 flex items-center justify-center bg-surface-elevated border border-border text-glow group-hover:bg-glow/10 transition-colors">

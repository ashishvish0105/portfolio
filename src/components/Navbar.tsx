  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-6 lg:px-8 h-16 flex items-center justify-between">
        ...
        <a
          href="#contact"
          className="hidden md:inline-flex items-center gap-2 px-4 py-2 border border-border text-xs font-mono uppercase tracking-widest text-foreground hover:border-glow hover:text-glow transition-all"
        >
        ...
        <div className="md:hidden border-t border-border bg-background/95 backdrop-blur-xl">
          <div className="flex flex-col px-6 py-4 gap-4">
            ...
            <a
              href="#contact"
              onClick={() => setOpen(false)}
              className="inline-flex w-fit items-center gap-2 px-4 py-2 border border-glow text-xs font-mono uppercase tracking-widest text-glow"
            >
              Hire Me
            </a>
          </div>
